                ...
                <tbody>
                    <c:forEach items="${data.journal}" var="columns">
                      <tr class="serial">
                        ...
                        <td width="30"><a href="/aes/edit.html?option=aes&action=edit&recordId=${recordId}"  title="<fmt:message key='edit' bundle='${content}'/>"><span class="fa fa-pencil"/></a></td>
                        <td width="30"><a href="/report/form.html?option=report&analysis=${code}&recordId=${recordId}&probeId=${probeId}"  title="<fmt:message key='make_report' bundle='${content}'/>"><span class="fa fa-print"/></a></td>
                        <td width="30"><a href="/aes/form.html?option=aes&action=delete&recordId=${recordId}"  title="<fmt:message key='delete' bundle='${content}'/>"><span class="fa fa-trash-o"/></a></td>
                      </tr>
                    </c:forEach>
                </tbody>
                <tfooter>
