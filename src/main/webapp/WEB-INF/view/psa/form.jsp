...
<t:header />
<h2><fmt:message key="PSA" bundle="${analysis}"/></h2>
<c:choose>
    <c:when test="${empty data.journal}">
        <t:createForm option="psa" />
    </c:when>
    <c:otherwise>
        <c:set var = "code" scope = "page" value = "psa"/>
            ...
            <table id="advancedTable" class="table table-striped table-hover table-condensed">
                ...
                <tbody>
                    <c:forEach items="${data.journal}" var="columns">
                      <tr class="serial">
                        ...
                        <td width="30"><a href="/psa/edit.html?option=psa&action=edit&recordId=${recordId}"
                        ...
                        <td width="30"><a href="/psa/form.html?option=psa&action=delete&recordId=${recordId}"
                ...
                <tfooter>
                    <tr>
                        <td></td>
                        <td colspan="48"></td>
                        <td><a href="/psa/edit.html?option=psa&action=add"><i class="fa fa-plus" title="<fmt:message key='create' bundle='${content}'/>"></i></a></td>
                    </tr>
                <tfooter>
            </table>
        </div>
